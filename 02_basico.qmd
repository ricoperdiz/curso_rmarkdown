...
+ Conhecer o que é RMarkdown e como ele se diferencia do Markdown simples;
+ Entender as vantagens de usar RMarkdown para relatórios reprodutíveis e documentos dinâmicos;
+ Identificar e compreender a estrutura básica de um arquivo RMarkdown, incluindo o cabeçalho YAML, os pedaços de código, e o corpo do documento;
...
+ Aprender a inserir e configurar pedaços de código dentro do documento RMarkdown;
+ Entender como executar código dentro de um documento RMarkdown e como controlar a saída desses códigos (exibição de código, resultados, gráficos, etc.).  
...
2. **Pedaço de código**: são blocos de código delimitados por três crases (```). Esses blocos de código podem ser executados e os resultados são incorporados ao documento final.  
