...
Para complementar, sugiro que o usuário faça seus trabalhos escritos utilizando um ambiente de desenvolvimento integrado (do inglês *Integrated Development Environment*, **IDE**; [acesse este link para saber o que é um IDE e quais as vantagens de se utilizá-lo](https://www.redhat.com/pt-br/topics/middleware/what-is-ide)).
Em seguida, deve-se instalar um ambiente LaTeX para poder gerar arquivos em formato *pdf*, e, por fim, deve-se instalar um organizador de bibliografias, *JabRef*, para lidar com arquivos em formato *bib*([veja aqui o que é um arquivo bib](https://www.reviversoft.com/pt/file-extensions/bib)).  
...
## Ambiente de desenvolvimento integrado - IDE (e.g., RStudio, VS code)
