...
Em seguida, necessitamos de um ambiente de desenvolvimento integrado (do inglês *Integrated Development Environment*, *IDE*; [acesse este link para saber o que é um _IDE_ e quais as vantagens de se utilizá-lo](https://www.redhat.com/pt-br/topics/middleware/what-is-ide)), que será onde o usuário poderá escrever seus textos.
...
+ Instalar o [R e pacotes necessários](#instala-r)
+ Instalar o [Rtools](#sec-rtools)
+ Instalar [distribuição LaTeX](#sec-latex)
+ Instalar um [IDE](#sec-ide)
+ Instalar um organizador[ de bibliografias](#sec-orgabib)
...
### Rtools para usuários Windows {#sec-rtools}
...
## Organizador de bibliografias {#sec-orgabib}

Existem vários organizadores de bibliografia.
Eu utilizo o [JabRef](https://www.jabref.org/#downloads).
...
::: {.callout-warning}
Caso o usuário tenha optado por utilizar um _IDE_ **diferente** do RStudio, será necessária a instalação do *Pandoc*.  
:::
