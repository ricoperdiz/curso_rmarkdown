...
A linguagem Rmarkdown possibilita a produção de inúmeros tipos de conteúdos diferentes em distintos formatos ([HTML](#sec-html), [PDF](#sec-pdf), DOCX, ODT etc).
Vejam abaixo algumas dessas possibilidades:


### Apresentação

Esta é uma apresentação criada por meio do pacote R [**xaringan**](https://github.com/yihui/xaringan).  
...
Essa é minha página pessoal, criada por meio do pacote R [**blogdown**](https://bookdown.org/yihui/blogdown/).  

```{r, echo=FALSE, eval=TRUE}
knitr::include_url("https://ricardoperdiz.com/")
```


*****

Discorro abaixo sobre os principais formatos ([HTML](#sec-html), [PDF](#sec-pdf), e DOCX) e sobre algumas funcionalidades específicas de determinados pacotes R.  
